...
class ComplexFeatureExtractor:
    ...
    def extract_gradient_features(self, data):
        ...
        # Compute statistics for each sample - reshape for speed
    ...
    def custom_normalize(self, features):
        ...
        """
        # Use einsum for fastest norm computation
        norm_sq = np.einsum('ij,ij->i', features, features)
        norms = np.sqrt(norm_sq + 1e-16)
